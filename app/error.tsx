...
export default function Error({
  ...
  return (
    <section className="bg-cream dark:bg-navy min-h-[calc(100vh-64px)] lg:min-h-[calc(100vh-80px)] flex items-center py-20">
      <div className="max-w-2xl mx-auto px-6 lg:px-8 text-center">
        ...
        <div className="flex flex-wrap gap-4 justify-center">
          ...
          <Link
            href="/"
            className="inline-flex items-center gap-2 px-7 py-3.5 border border-navy/25 dark:border-white/30 text-navy dark:text-white font-semibold rounded-full hover:border-navy dark:hover:border-white hover:bg-navy/5 dark:hover:bg-white/5 transition-colors duration-200"
          >
            Back to home
          </Link>
        </div>
