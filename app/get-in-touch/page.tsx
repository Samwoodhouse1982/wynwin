...
const contactLinks = [
  {
    ...
    label: 'Phone',
    value: BRAND.phone,
    icon: <Phone size={16} className="text-pink" />,
    external: false,
  },
  {
    ...
    label: 'Email',
    value: BRAND.email,
    icon: <Mail size={16} className="text-pink" />,
    external: false,
  },
  {
    href: BRAND.linkedin,
    label: 'LinkedIn',
    value: 'WYN WIN on LinkedIn',
    icon: (
          ...
          <div className="lg:col-span-2">
            <Reveal stagger>
              ...
              {contactLinks.map((link) => (
                <RevealItem key={link.label} direction="left">
                  <a
                    href={link.href}
                  ...
                  >
                    <div className="w-10 h-10 rounded-full bg-pink/20 flex items-center justify-center group-hover:bg-pink/40 group-hover:scale-110 transition-all duration-200">
                      {link.icon}
                    </div>
                    <div>
